<template>
    <div class="fixed w-full h-full blurd-bg text-secondary-500">
        <div class="md:flex h-full backdrop-blur-lg bg-secondary-100/80">
            <aside @click="sideToggle"
                class="z-50 lg:w-[300px] shrink-0 text-secondary-800 bg-white/80 backdrop-blur shadow py-7 h-full lg:mb-7 lg:mt-2 lg:mx-2 lg:bottom-7 lg:left-2 rounded-md overflow-x-hidd overflow-y-auto absolute lg:static lg:translate-x-0 -translate-x-full transition-all">
                <nav class="flex flex-col px-2 md:px-2 text-secondary-600">
                    ...
                    <Link href="/user" v-if="$page.props.auth.user.role == 'admin'"
                        class="flex line-clamp-1 place-items-center overflow-hidden px-4 py-2 rounded hover:bg-secondary-200 hover:text-secondary-800 transition">
                    ...
                    <Link href="transactions"
                        class="flex line-clamp-1 place-items-cent~er overflow-hidden px-4 py-2 rounded hover:bg-secondary-200 hover:text-secondary-800 transition">
                    <i class="fa-solid fa-plus-circle w-7 mr-3"></i>
                    Transactions
                    </Link>
                    <Link href="/settings" v-if="$page.props.auth.user.role == 'admin'"
                        class="flex line-clamp-1 place-items-cent~er overflow-hidden px-4 py-2 rounded hover:bg-secondary-200 hover:text-secondary-800 transition">
                    <i class="fa-solid fa-plus-circle w-7 mr-3"></i>
                    Setings
                    </Link>
            ...
            <main class="flex-auto h-full text-gray-500">
                <div class="flex px-2 py-2 m-2 rounded-md place-items-center backdrop-blur bg-white/80 border-b">
                    <!-- menu button -->
                    <button @click="sideToggle"
                        class="xl:hidden rounded p-2 bg-secondary-50 h-10 flex gap-2 place-items-center justify-center text-secondary-500 hover:bg-secondary-500 hover:text-white transition ">
                    ...
                    <div class="flex space-x-4">
                        <div class="hidden md:flex rounded-md border border-secondary-400 bg-white overflow-hidden">
                            <input type="search" name="search" id="search" class="border-0 bg-none"
                                placeholder="Search">
                            <button
                                class="px-2 border-l bg-secondary-50 hover:bg-secondary-500 hover:text-white text-secondary-500 transition">
