...
export default {
    ...
    setup() {
        ...
        const imagePreview = (el, pos) => {
            ...
            switch (pos) {
                case 0:
                    preview_1.value = url;
                    form.image_1 = el.target.files[0];
                    break;
                case 1:
                    preview_2.value = url;
                    form.image_2 = el.target.files[0];
                    break;
                case 2:
                    preview_3.value = url;
                    form.image_3 = el.target.files[0];
                    break;
                case 3:
                    preview_4.value = url;
                    form.image_4 = el.target.files[0];
                    break;
                case 4:
                    preview_5.value = url;
                    form.image_5 = el.target.files[0];
                    break;
                case 5:
                    preview_6.value = url;
                    form.image_6 = el.target.files[0];
                    break;
                case 6:
                    preview_7.value = url;
                    form.image_7 = el.target.files[0];
                    break;

                case 7:
                    form.file_1 = el.target.files[0];
                    break;
                case 8:
                    form.file_2 = el.target.files[0];
                    break;
                case 9:
                    form.file_3 = el.target.files[0];
                    break;
                case 10:
                    form.file_4 = el.target.files[0];
                    break;
            }
        };
    ...
    mounted() {
        ...
        this.preview_1 = this.plan.image_1;
        this.preview_2 = this.plan.image_2;
        this.preview_3 = this.plan.image_3;
        this.preview_4 = this.plan.image_4;
